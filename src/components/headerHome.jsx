...
export default function HeaderHome() {
  return (
    <section className="relative w-full flex flex-col overflow-x-hidden bg-[url('/2lct-page-accueil-code-site-web.png')] bg-cover bg-center z-[998] min-h-screen pt-32 justify-center items-center">
      <div className="absolute inset-0 bg-black/80 z-0"></div>
      <ParticlesBackground />

      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 
        text-white text-center px-6 md:px-0 z-20 max-w-4xl w-full flex flex-col gap-6 md:gap-10 py-20 max-w-4xl">
