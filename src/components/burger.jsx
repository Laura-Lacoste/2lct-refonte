...
export default function Burger() {
  ...
  return (
    <div className="fixed py-2 px-6 bg-[#050305] flex justify-between items-center w-full md:hidden z-50">
      <Link href="/">
      ...
      >
        <span className="w-[7px] h-[7px] rounded-sm bg-[#E58BD3] transition-all" />
        <span className="w-[7px] h-[7px] rounded-sm bg-[#E58BD3] transition-all" />
        <span className="w-[7px] h-[7px] rounded-sm bg-[#E58BD3] transition-all" />
      </div>
      ...
      >
        ...
        <Link
          href="/contact"
          onClick={toggleBurger}
          className="bg-[#E58BD3] text-white px-4 py-2 rounded-sm hover:bg-white hover:text-[#E58BD3] border border-[#E58BD3] transition-all duration-300"
        >
          Contact
        </Link>
      </div>
